...
export class AuthService {
  ...
  private readonly SESSION_DURATION = 10 * 365 * 24 * 60 * 60 * 1000; // ~10 anos (logoff automático desativado)
  ...
  checkAuthStatus() {
    ...
    // Verificação de expiração desativada — sessão permanece até logout manual
